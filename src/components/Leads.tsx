      ...
      <Box>
        ...
        <Box display="flex" justifyContent="space-between" alignItems="center" mb={3}>
          <Box>
            ...
            <Typography variant="body2" color="text.secondary" sx={{ fontFamily: "'Manrope', sans-serif", fontSize: '18px', color: 'text.secondary' }}>
                ...
                <TableBody>
                  {filteredLeads.map((lead) => (
                    <TableRow key={lead.id} hover>
                      <TableCell>
                        <Typography variant="body2" sx={{ fontFamily: "'Manrope', sans-serif", fontSize: '16px', color: 'text.primary' }}>{formatDate(lead.call_start_time)}</Typography>
                      </TableCell>
                      <TableCell>
